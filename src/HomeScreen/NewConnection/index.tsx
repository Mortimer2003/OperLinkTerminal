import {
  ...
  useColorScheme,
  Dimensions, Modal, FlatList, ImageBackground, Easing, Animated
} from "react-native";
import * as React from "react";
import { useContext, useEffect, useLayoutEffect, useRef, useState } from "react";
import { Colors } from "react-native/Libraries/NewAppScreen";
import { header, HostContext, saveData } from "../index";
    ...
    <SafeAreaView style={backgroundStyle}>
      ...
      <View /*contentInsetAdjustmentBehavior="automatic"*/ style={backgroundStyle}>
        ...
        <View style={styles.body}>
          ...
          {/*—————————————————————————————保存————————————————————————————————*/}
          <View style={{flexGrow: 1,justifyContent:'flex-end', marginBottom: 30}}>
            <TouchableOpacity
              activeOpacity={0.5}
              onPress={handleSave}
              style={styles.button}
